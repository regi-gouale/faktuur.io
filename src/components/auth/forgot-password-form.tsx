...
export function ForgotPasswordForm() {
  ...
  return (
    <Card className="w-full overflow-hidden rounded-4xl">
      <CardHeader>
        <CardTitle className="text-center text-xl font-bold">Mot de passe oublié ?</CardTitle>
        <CardDescription className="text-left">
          Veuillez entrer votre adresse email pour recevoir un lien de réinitialisation de mot de
          passe.
        </CardDescription>
      </CardHeader>
      <CardContent>
...
export const ForgotPasswordFormFallback = () => {
  return (
    <Card className="w-full overflow-hidden rounded-4xl">
      ...
      <CardContent>Veuillez patienter pendant le chargement du formulaire...</CardContent>
    </Card>
  );
};
